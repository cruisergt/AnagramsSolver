...
public class AnagramHolder {
    ...
    /**
     * Constructor used when anagrams are being formed
     * @param original original String
     * @param word String that contains some or all characters of the original String
     * @param availableLetters letters that may still be added to this word to create more anagrams
     */
